...
class VisitorsFrequenciesDurationWidget extends StatsOverviewWidget
{
    use CanViewWidget;
    ...
    {
        return [
            MAStatsBuilder::make(__('matomo-analytics::widgets.visitors_frequencies_duration'), 'time')
                ->usingResponse(MAResponse::common(MADataLookups::visitsReturningDuration(), $this->filter))
