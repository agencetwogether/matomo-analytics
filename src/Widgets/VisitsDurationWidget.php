...
class VisitsDurationWidget extends StatsOverviewWidget
{
    use CanViewWidget;
    ...
    {
        return [
            MAStatsBuilder::make(__('matomo-analytics::widgets.visits_duration'), 'time')
                ->usingResponse(MAResponse::common(MADataLookups::visitsDuration(), $this->filter))
