...
class VisitsWidget extends StatsOverviewWidget
{
    use CanViewWidget;
    ...
    {
        return [
            MAStatsBuilder::make(__('matomo-analytics::widgets.visits'))
                ->usingResponse(MAResponse::common(MADataLookups::visits(), $this->filter))
